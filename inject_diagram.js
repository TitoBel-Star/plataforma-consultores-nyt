...
// The diagram HTML
const diagramHTML = `
            <!-- 16.5 ECOSISTEMA NYTEX -->
            <div class="bg-gray-900 rounded-2xl p-6 shadow-2xl overflow-x-auto border border-gray-700 mb-12">
...
// Insert just above the buttons in #contacto
if (html.includes('<div class="flex flex-col sm:flex-row justify-center gap-6">')) {
    html = html.replace('<div class="flex flex-col sm:flex-row justify-center gap-6">', diagramHTML);
    console.log("Successfully inserted diagram into #contacto section.");
} else {
    console.log("Could not find the target buttons container.");
}

// Ensure mermaid script is there, using ESM module approach which is much more reliable for Mermaid 10+
